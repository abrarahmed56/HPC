...
int main() {
  ...
  double *x1;
  cudaMallocHost((void**)&x1, N * sizeof(double));
  double *x2;
  cudaMallocHost((void**)&x2, N * sizeof(double));
  ...
  cudaMemcpyAsync(x1_d, x1, N*sizeof(double), cudaMemcpyHostToDevice);
